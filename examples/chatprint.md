...
> Name: `Chat Print`  
>
> Description: `Printing text inside in-game chat`
...
local CHudChat = FindElement(ffi.cast("unsigned long**", Utils.PatternScan("client.dll", "B9 ? ? ? ? E8 ? ? ? ? 8B 5D 08") + 1)[0], "CHudChat")
